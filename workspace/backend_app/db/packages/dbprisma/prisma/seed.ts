...
async function main() {
  ...
  const DoubleLegBackStretch = await prisma.workout.create({
    data: {
      ...
      hold_3: 15,
      sensors: ["IMU"],
      video: "Double Leg Back Stretch.mp4",
    },
  });
  ...
  const ZipAndAbdominalHollowing = await prisma.workout.create({
    data: {
      ...
      video: "Zip and Abdominal Hollowing.mp4",
    },
  });
  ...
  const ZipAndAbdominalHollowingAdvanced = await prisma.workout.create({
    data: {
      ...
      hold_3: 8,
      sensors: ["Rectus", "Transversus"],
      video: "Seated Zip and Abdominal Hollowing.mp4",
    },
  });
  ...
  const SupineBridgeAdvanced = await prisma.workout.create({
    data: {
      ...
      hold_3: 8,
      sensors: ["Transversus", "Spinal"],
      video: "Supine Bridge Advanced.mp4",
    },
  });
    ...
    data: {
      ...
      workouts: {
        create: [
          ...
          {
            order: 4,
            workout: { connect: { id: ZipAndAbdominalHollowingAdvanced.id } },
          },
    ...
    data: {
      ...
      workouts: {
        create: [
          ...
          {
            order: 4,
            workout: { connect: { id: ZipAndAbdominalHollowing.id } },
          },
  ...
  await prisma.programme.create({
    data: {
      name: "MMG",
      workouts: {
        create: [{ workout: { connect: { id: ZipAndAbdominalHollowing.id } } }],
      },
    },
  });
  ...
  await prisma.programme.create({
    data: {
      name: "Minimal",
      workouts: {
        create: [{ workout: { connect: { id: CatCamelStretch.id } } }],
      },
    },
  });
}
